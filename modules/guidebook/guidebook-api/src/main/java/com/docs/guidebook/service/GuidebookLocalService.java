...
public interface GuidebookLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link GuidebookLocalServiceUtil} to access the guidebook local service. Add custom service methods to <code>com.docs.guidebook.service.impl.GuidebookLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
